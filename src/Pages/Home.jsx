  ...
  return (
    <section class="bg-white dark:bg-gray-900 text-center">
      <div class="py-8 px-4  text-center lg:py-16">
        <div class="mb-4 text-4xl  tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Hi, I'm Walter Kiprono</div>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Tag me on ReactJs, NodeJs, Flutter, ASP.NET and .NETcore Projects</p>
